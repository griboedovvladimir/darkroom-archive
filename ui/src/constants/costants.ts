export const cameras: Record<
  string,
  { value: string; label: string; format: string; formatCode?: string, focalLength?: number }[]
> = {
  '120': [
    {value: '1', label: 'Hasselblad 500CM', format: '6x6', formatCode: '66'},
    {value: '2', label: 'Rolleiflex 2.8C', format: '6x6', formatCode: '66', focalLength: 80},
    {value: '3', label: 'Diana F+', format: '6x6', formatCode: '66'},
    {
      value: '4',
      label: 'Voigtlander Bessa 46',
      format: '6x4.5',
      formatCode: '645',
      focalLength: 75,
    },
  ...
  '135': [
    {value: '1', label: 'Rolie 35S', format: 'full', formatCode: 'FF', focalLength: 50},
    ...
    {value: '5', label: 'Lomo LC-A', format: 'full', formatCode: 'FF', focalLength: 28},
    {value: '6', label: 'Olympus mju II', format: 'full', formatCode: 'FF', focalLength: 35},
  ],
};
...
export const filmStocks = [
  ...
  {
    value: '35',
    label: 'Fujifilm Neopan 100 Acros II',
    iso: 100,
    color: 'BW',
    process: 'BW',
  },
  {
    value: '36',
    label: 'Fujifilm Neopan 400 Super',
    iso: 400,
    color: 'BW',
    process: 'BW',
  },
  {
    value: '37',
    label: 'Fujifilm Neopan 1600 Super',
    iso: 1600,
    color: 'BW',
    process: 'BW',
  },
  ...
  {
    value: '51',
    label: 'Ilford Ilfocolor 400 plus',
    iso: 400,
    color: 'C',
    process: 'C41',
  },
...
export const getAllCameraOptions = () => {
  ...
  return allCameras.map((camera, idx) => ({
    value: idx + 1,
    label: camera.label,
  }));
};

export const getCameraOptions = (filmType: FilmType) =>
  cameras[filmType].map(({value, label}) => ({value, label}));
export const formatOptions = (filmType: FilmType) =>
  Formats[filmType].map((format) => ({value: format, label: format}));

export const Formats = Object.keys(cameras).reduce(
  (acc, type) => {
    acc[type] = cameras[type]
